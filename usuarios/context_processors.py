...
def permisos_menu(request):
    ...
    if not user.is_authenticated:
        return {
            ...
            "puede_ver_diaristas": False,
            "puede_ver_permisos": False,
            "puede_ver_vacaciones": False,
            "puede_ver_comunicaciones": False,
            "puede_ver_icl": False,
    ...
    return {
        ...
        "puede_ver_diaristas": tiene_permiso(user, "diaristas", "puede_ver"),
        "puede_ver_permisos": tiene_permiso(user, "permisos", "puede_ver"),
        "puede_ver_vacaciones": tiene_permiso(user, "vacaciones", "puede_ver"),
        "puede_ver_comunicaciones": tiene_permiso(user, "comunicaciones", "puede_ver"),
